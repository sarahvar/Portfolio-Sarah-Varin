  ...
  return (
    <div className="experience">
      ...
      <div className="exp-2">
        ...
        <p className="paragraph-margin">
          J'ai fait du maquettage pour un client. <br /> Développer une API en mettant en oeuvre des opérations CRUD en PHP <br /> J'ai écrit des tests unitaires et d'intégration.
        </p>
      </div>
    </div>
  );
